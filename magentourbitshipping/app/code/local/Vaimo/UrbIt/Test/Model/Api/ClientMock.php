...
class Vaimo_UrbIt_Test_Model_Api_ClientMock
{
    ...
    private function _mockApiCreateOrderResponseSuccess()
    {
        return json_decode('{
          "order_number": 1,
    ...
    private function _mockApiValidateDeliveryResponseSuccess()
    {
        return json_decode('{
     ...
     */
    private function _mockApiServiceUnavailableErrorResponse()
    {
        return json_decode('{
          "status": 503,
          "code": "503",
     ...
     */
    private function _mockApiUnauthorizedErrorResponse()
    {
        return json_decode('{
          "status": 401,
          "code": "401",
     ...
     */
    private function _mockApiUnprocessableEntityErrorResponse()
    {
        return json_decode('{
          "status": 422,
          "code": "422",
     ...
     */
    private function _mockApiRetailerUnauthorizedErrorResponse()
    {
        return json_decode('{
          "status": 401,
          "code": "RET-001",
     ...
     */
    private function _mockApiInvalidDeliveryLocationErrorResponse()
    {
        return json_decode('{
          "status": 500,
          "code": "RET-002",
     ...
     */
    private function _mockApiInvalidPickupLocationErrorResponse()
    {
        return json_decode('{
          "status": 500,
          "code": "RET-003",
     ...
     */
    private function _mockApiInvalidDeliveryDateTimeErrorResponse()
    {
        return json_decode('{
          "status": 500,
          "code": "RET-004",
