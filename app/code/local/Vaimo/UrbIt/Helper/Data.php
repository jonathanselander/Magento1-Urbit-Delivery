...
class Vaimo_UrbIt_Helper_Data extends Mage_Core_Helper_Data
{
    ...
    {
        return Mage::getStoreConfigFlag('carriers/' . Vaimo_UrbIt_Model_System_Config_Source_Environment::CARRIER_CODE . '/only_specific_products_allowed');
    }
    ...
    {
        $statuses = Mage::getStoreConfig('carriers/' . Vaimo_UrbIt_Model_System_Config_Source_Environment::CARRIER_CODE . '/status_list');
